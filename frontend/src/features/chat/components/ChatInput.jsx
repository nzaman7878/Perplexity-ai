        ...
        >
          ...
          <div className='mt-2 flex items-center justify-between pt-2'>
            <div className='flex items-center gap-1'>
              ...
              <button type="button" className='flex items-center justify-center rounded-full h-8 w-8 text-[#6e6e8a] hover:bg-[#20213a] hover:text-[#e8e8f0] transition-colors' title="Voice Input">
